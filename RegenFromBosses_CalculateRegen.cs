using Terraria; //For the hardcoded vanilla boss/mini-boss/event checks
...
//and multiplies the percentage of cleared things by the max regeneration values in the configuration
